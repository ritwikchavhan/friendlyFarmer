...
/***/ "FXsH":
/*!************************************************!*\
  !*** ./src/app/api/loading/loading.service.ts ***!
  \************************************************/
...
/***/ "Mdsl":
/*!********************************************!*\
  !*** ./src/app/api/toast/toast.service.ts ***!
  \********************************************/
...
/***/ "V1Sa":
/*!********************************************!*\
  !*** ./src/app/api/alert/alert.service.ts ***!
  \********************************************/
...
let AuthService = class AuthService {
    ...
    register(data) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            console.log(data);
            return yield this._http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].base_url}/auth/register.php`, data);
        });
    }
    login(data) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            // let options = new RequestOptions({ headers: headers });
            console.log(data);
            return yield this._http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].base_url}/auth/login.php`, data);
        });
    }
};
